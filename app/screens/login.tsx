...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // 3️⃣ Fetch patient data if role is patient
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: 'bold', color: '#067425', marginBottom: 20 },
  ...
  Btn: { width: '90%', backgroundColor: '#067425', padding: 15, borderRadius: 8, marginBottom: 10, justifyContent: 'center', alignItems: 'center' },
  LoginText: { color: '#fff', textAlign: 'center', fontWeight: 'bold' },
  PassContainer: { width: '90%', marginBottom: 20, alignItems: 'flex-end' },
  link: { fontSize: 13, color: '#007bff' },
});
